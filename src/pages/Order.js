          ...
          {cart.map((product, index) => {
            ...
            return (
              <tr key={uuid()}>
                ...
                <td><a href='#' onClick={() => removeFromCart(product)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16">
